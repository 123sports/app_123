...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "On Tennis — Olimpio Neto" },
      { property: "og:description", content: "Exercício físico e saúde. Reserve sua quadra e suas aulas de tênis." },
      { name: "twitter:description", content: "Exercício físico e saúde. Reserve sua quadra e suas aulas de tênis." },
    ],
    links: [
